...
from ml.shap_engine.engine import SHAPEnginePytorch
...
def create_app(config=None):
    ...
    # load dataset
    if app.config['DATASET'] == 'student-grade':
        app.dataset = load_student_grade_dataset()
    else:
...
def add_arguments_server(parser):
    ...
    parser.add_argument('--dataset', default='student-grade', type=str, help="The name of the dataset")
